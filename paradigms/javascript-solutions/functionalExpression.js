const op = (f) => Object.defineProperty((...arg) => (...vars) => f(...arg.map(calc => calc(...vars))), "length", {value: f.length})
...
const sinh = op((value) => Math.sinh(value))
const cosh = op((value) => Math.cosh(value))
